...
def lists():
    values_list.append([Credits,Defer,Fail])
...
while True:
    ...
    for [Credits,Defer,Fail],Results in zip(values_list,Results_list):  #https://www.w3schools.com/python/ref_func_zip.asp
        print(Results,"-",Credits,Defer,Fail)
    break
